...
RSpec.describe BucklerBridge do
  subject(:buckler_bridge) { described_class.new(api:)  }
  ...
  describe "#search_fighter_banner" do
    ...
    it { expect(buckler_bridge.search_fighter_banner(term: 'player')).to eq [ 1, 2 ] }
    it { expect(buckler_bridge.search_fighter_banner(term: '123456789')).to eq [ 3, 4, 5 ] }
    it { expect(buckler_bridge.search_fighter_banner(term: 'player_x')).to eq [] }
  ...
  describe "#fighter_banner" do
    ...
    it { expect(buckler_bridge.fighter_banner(short_id: '123456789')).to eq 1 }
    it { expect { buckler_bridge.fighter_banner(short_id: '123456788') }.to raise_error BucklerBridge::PlayerNotFound }
  ...
  describe "#battle_list" do
    ...
    it { expect(buckler_bridge.battle_list(short_id: '123456789').to_a).to eq [ 1, 2 ] }
