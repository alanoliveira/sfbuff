...
ActiveRecord::Schema[8.1].define(version: 2025_12_24_130252) do
  ...
  create_table "battles", force: :cascade do |t|
    ...
    t.index ["p1_fighter_id", "p1_character_id", "played_at"], name: "idx_ranked_history_p1", where: "(battle_type_id = 1)"
  ...
  create_table "current_leagues", force: :cascade do |t|
    ...
    t.integer "mr"
    t.datetime "updated_at", null: false
    t.index ["fighter_id", "character_id"], name: "index_current_leagues_on_fighter_id_and_character_id", unique: true
    t.index ["fighter_id"], name: "index_current_leagues_on_fighter_id"
  end
  ...
  create_table "fighter_searches", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "uuid"
    t.index ["uuid"], name: "index_fighter_searches_on_uuid", unique: true
  end
  ...
  create_table "fighter_synchronizations", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.string "uuid"
    t.index ["created_at"], name: "index_fighter_synchronizations_on_created_at"
    t.index ["fighter_id"], name: "idx_unique_unfinished_synchronization", unique: true, where: "(status = ANY (ARRAY[0, 1]))"
  ...
  create_table "session_events", force: :cascade do |t|
    ...
    t.index ["session_id"], name: "index_session_events_on_session_id"
  end
  ...
  add_foreign_key "session_events", "sessions"
